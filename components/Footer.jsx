...
export default function Footer() {
  ...
  />
 <button
  className="bg-gray-800 hover:bg-gray-900 text-white min-w-[110px] px-4 sm:px-6 py-1 sm:py-2 text-xs sm:text-sm font-semibold flex items-center justify-center gap-1"
